<div class="navbar bg-base-100  px-10 py-5 sticky top-0 z-50">
    <div class="navbar-start mx-auto">
        ...
        <div class="mx-5 flex flex-row gap-4 justify-start">
            ...
            <button
                class="flex flex-row gap-0.5 text-lg font-light hover:text-gray-600 hover:bg-transparent hover:border-0 hover:shadow-none"
                popovertarget="popover-layanan">
                <p>Layanan</p>
                <span class="arrow-up mt-1 hidden"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                ...
                <span class="arrow-down mt-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor" class="size-5">
                        <path fill-rule="evenodd"
            ...
            <button
                class="flex flex-row gap-0.5 text-lg font-light hover:text-gray-600 hover:bg-transparent hover:border-0 hover:shadow-none"
                popovertarget="popover-jelajahi">
                <p>Jelajahi</p>
                <span class="arrow-up mt-1 hidden"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                        fill="currentColor" class="size-5">
                        <path fill-rule="evenodd"
            ...
            <div class="fixed top-24 w-[818px] left-1/2 transform -translate-x-1/2 dropdown p-8 bg-base-100 shadow-xl rounded-2xl"
                popover id="popover-jelajahi" style="position-anchor:--anchor">
            ...
            <div class="fixed top-24 w-[818px] left-1/2 transform -translate-x-1/2 dropdown p-8 bg-base-100 shadow-xl rounded-2xl"
                popover id="popover-bantuan" style="position-anchor:--anchor">
                <div class="grid grid-cols-2 gap-2">
                    <div class="flex flex-col">
                        <a href="#" class="flex flex-row gap-6 py-3 px-4 rounded-xl hover:bg-base-200 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="dropdown dropdown-center top-36 menu w-52 rounded-box bg-base-100 shadow-sm" popover
