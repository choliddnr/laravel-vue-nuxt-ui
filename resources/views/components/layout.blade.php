...
<body class="font-sans antialiased h-full bg-slate-200">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                {{-- <a href="/" class="{{$title == 'Home' ? $activeNavLink : $nonactiveNavLink}}"
                                    aria-current="page">Home</a>
                                <a href="/blog"
                                    class="{{$title == 'Blog' ? $activeNavLink : $nonactiveNavLink}}">Blog</a>
                                <a href="/about"
                                    class="{{$title == 'About' ? $activeNavLink : $nonactiveNavLink}}">About</a>
                                <a href="/contact"
                                    class="{{$title == 'Contact' ? $activeNavLink : $nonactiveNavLink}}">Contact</a>
                                --}}
